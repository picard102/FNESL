	...
	while ( have_posts() ) :
		...
		<main class="wp-site-blocks">
			<section class="alignwide px-6">
				<div class="overflow-hidden rounded-[2rem] border border-primary-100 bg-background shadow-[0_20px_60px_rgba(48,89,110,0.08)]">
					<div class="bg-[linear-gradient(135deg,rgba(188,220,229,0.55),rgba(244,244,249,0.9))] px-6 py-8 md:px-10 md:py-12">
						...
						<div class="mt-6 grid gap-8 lg:grid-cols-[minmax(0,1.5fr)_minmax(19rem,0.85fr)] lg:items-start">
							<div class="min-w-0">
								<div class="flex flex-wrap items-center gap-3">
									<p class="text-sm uppercase tracking-[0.22em] text-primary-600"><?php esc_html_e( 'Career Opportunity', 'fnesl' ); ?></p>
									<?php if ( $job_type ) : ?>
								...
								<?php if ( $application_email ) : ?>
									<div class="mt-8 flex flex-wrap items-center gap-4">
										...
										<p class="text-sm text-primary-700"><?php echo esc_html( antispambot( $application_email ) ); ?></p>
									</div>
								<?php endif; ?>
							</div>
			...
			<section class="alignwide px-6">
				<div class="grid gap-12 lg:grid-cols-[minmax(0,1.5fr)_minmax(19rem,0.85fr)]">
					<article class="prose max-w-none rounded-[1.5rem] border border-primary-100 bg-white p-6 text-primary-900 shadow-[0_10px_30px_rgba(48,89,110,0.05)] md:p-8">
						<h2 class="not-prose mb-6 text-sm uppercase tracking-[0.22em] text-primary-500"><?php esc_html_e( 'Role Overview', 'fnesl' ); ?></h2>
						<?php the_content(); ?>
					</article>
